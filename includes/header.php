        ...
        <nav class="container mx-auto px-4 py-3">
            <div class="flex justify-between items-center">
                ...
                <ul class="flex space-x-4 space-x-reverse">
                    ...
                    <li><a href="/modules/department/add.php" class="hover:text-blue-200">إضافة قسم</a></li>
                    <li><a href="/modules/status/add.php" class="hover:text-blue-200">إضافة حالة</a></li>
                </ul>
            </div>
        </nav>
    </header>
